...
//        parentVertex.setCoordinate(algorithm.moveTheVertex(parentVertex, force).getCoordinate());
        for (Vertex vertex : childrenList) {
//            vertex.setCoordinate(algorithm.moveTheVertex(vertex, force).getCoordinate());
            if (isFirst) {
                isFirst = false;
