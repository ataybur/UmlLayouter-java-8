...
//            Double yTemp = firstLine.getSlope() * x + firstLine.getIntercept();
//            System.out.println("y: " + y + ", yTemp: " + yTemp + ",firstLine.getSlope(): " + firstLine.getSlope() + ", firstLine.getIntercept(): " + firstLine.getIntercept());
//            System.out.println("areThereConflictedLines Ends " + y.equals(yTemp));
            return result;
        }
    }
